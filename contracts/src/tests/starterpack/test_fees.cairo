...
#[test]
fn test_fees_distribution_no_referrer() {
    // [Setup]
...
#[test]
fn test_fees_distribution_with_referrer() {
    // [Setup]
    let (_world, systems, context) = spawn();
...
fn test_quote_calculation() {
    ...
    assert_eq!(
        quote_with_ref.protocol_fee, PRICE * PROTOCOL_FEE.into() / FEE_DENOMINATOR.into()
    );
