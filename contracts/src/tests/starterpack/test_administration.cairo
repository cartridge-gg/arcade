...
#[test]
fn test_administration_initialize_once() {
    // [Setup]
...
#[test]
#[should_panic(expected: 'Starterpack: already initialized')]
fn test_administration_initialize_already_initialized() {
    // [Setup]
    ...
    // [Initialize] Try again - should fail
    systems
        .starterpack_admin
        .initialize(
            protocol_fee: PROTOCOL_FEE, fee_receiver: RECEIVER(), owner: OWNER(),
...
#[test]
fn test_administration_set_protocol_fee() {
    // [Setup]
    let (world, systems, _context) = spawn();
...
fn test_administration_set_protocol_fee_unauthorized() {
    // [Setup]
...
#[test]
fn test_administration_grant_revoke_role() {
    // [Setup]
    let (_world, systems, context) = spawn();
...
#[test]
fn test_administration_set_fee_receiver() {
    // [Setup]
