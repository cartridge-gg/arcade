...
export function SidebarToggle({ className }: SidebarToggleProps) {
  ...
  return (
    <Button
      ...
      size="icon"
      onClick={toggle}
      className={cn("h-10 w-10 z-50 transition-all duration-300", className)}
