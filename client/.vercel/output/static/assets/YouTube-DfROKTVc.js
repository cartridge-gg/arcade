import { g as U, u as I, p as L, r as M, __tla as __tla_0 } from "./index-B2_K2A5s.js";
let q;
let __tla = Promise.all([
  ...
  var k = Object.create, u = Object.defineProperty, N = Object.getOwnPropertyDescriptor, j = Object.getOwnPropertyNames, V = Object.getPrototypeOf, B = Object.prototype.hasOwnProperty, x = (a, e, t) => e in a ? u(a, e, {
    ...
    return a;
  }, F = (a, e, t) => (t = a != null ? k(V(a)) : {}, v(!a || !a.__esModule ? u(t, "default", {
    value: a,
    enumerable: true
  }) : t, a)), H = (a) => v(u({}, "__esModule", {
    value: true
  }), a), o = (a, e, t) => (x(a, typeof e != "symbol" ? e + "" : e, t), t), w = {};
  K(w, {
    default: () => O
  });
  var S = H(w), b = F(M), p = I, D = L;
  ...
  class O extends b.Component {
    constructor() {
      super(...arguments), o(this, "callPlayer", p.callPlayer), o(this, "parsePlaylist", (e) => {
        ...
        const { data: t } = e, { onPlay: s, onPause: r, onBuffer: n, onBufferEnd: P, onEnded: _, onReady: g, loop: y, config: { playerVars: l, onUnstarted: h } } = this.props, { UNSTARTED: d, PLAYING: c, PAUSED: i, BUFFERING: E, ENDED: A, CUED: C } = window[T].PlayerState;
        if (t === d && h(), t === c && (s(), P()), t === i && r(), t === E && n(), t === A) {
