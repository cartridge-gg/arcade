import { g as y, r as v, __tla as __tla_0 } from "./index-B2_K2A5s.js";
let A;
let __tla = Promise.all([
  ...
  function w(r, e) {
    for (var t = 0; t < e.length; t++) {
      ...
      if (typeof n != "string" && !Array.isArray(n)) {
        for (const a in n) if (a !== "default" && !(a in r)) {
  ...
  var P = Object.create, s = Object.defineProperty, O = Object.getOwnPropertyDescriptor, x = Object.getOwnPropertyNames, I = Object.getPrototypeOf, j = Object.prototype.hasOwnProperty, E = (r, e, t) => e in r ? s(r, e, {
    enumerable: true,
    configurable: true,
    writable: true,
    value: t
  }) : r[e] = t, S = (r, e) => {
    for (var t in e) s(r, t, {
      get: e[t],
      enumerable: true
    });
  }, _ = (r, e, t, n) => {
    if (e && typeof e == "object" || typeof e == "function") for (let a of x(e)) !j.call(r, a) && a !== t && s(r, a, {
      get: () => e[a],
      enumerable: !(n = O(e, a)) || n.enumerable
    });
    return r;
  }, C = (r, e, t) => (t = r != null ? P(I(r)) : {}, _(!r || !r.__esModule ? s(t, "default", {
    value: r,
    enumerable: true
  }) : t, r)), N = (r) => _(s({}, "__esModule", {
    value: true
  }), r), p = (r, e, t) => (E(r, typeof e != "symbol" ? e + "" : e, t), t), g = {};
  S(g, {
    default: () => k
  });
  var m = N(g), i = C(v);
  ...
  class k extends i.Component {
    constructor() {
      super(...arguments), p(this, "mounted", false), p(this, "state", {
        image: null
