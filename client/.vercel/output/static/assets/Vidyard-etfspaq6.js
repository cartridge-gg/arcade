import { g as m, u as v, p as b, r as O, __tla as __tla_0 } from "./index-B2_K2A5s.js";
let K;
let __tla = Promise.all([
  ...
  var D = Object.create, i = Object.defineProperty, j = Object.getOwnPropertyDescriptor, w = Object.getOwnPropertyNames, S = Object.getPrototypeOf, M = Object.prototype.hasOwnProperty, A = (t, e, r) => e in t ? i(t, e, {
    enumerable: true,
    configurable: true,
    writable: true,
    value: r
    ...
    if (e && typeof e == "object" || typeof e == "function") for (let a of w(e)) !M.call(t, a) && a !== r && i(t, a, {
      get: () => e[a],
      enumerable: !(s = j(e, a)) || s.enumerable
    });
    return t;
  }, L = (t, e, r) => (r = t != null ? D(S(t)) : {}, h(!t || !t.__esModule ? i(r, "default", {
    value: t,
    enumerable: true
  }) : r, t)), R = (t) => h(i({}, "__esModule", {
    value: true
  }), t), o = (t, e, r) => (A(t, typeof e != "symbol" ? e + "" : e, r), r), _ = {};
  E(_, {
    default: () => y
  });
  var f = R(_), c = L(O), d = v, P = b;
  ...
  class y extends c.Component {
    ...
    load(e) {
      ...
      this.player && this.stop(), (0, d.getSDK)(x, C, N).then((p) => {
        this.container && (p.api.addReadyListener((u, g) => {
          this.player || (this.player = g, this.player.on("ready", this.props.onReady), this.player.on("play", this.props.onPlay), this.player.on("pause", this.props.onPause), this.player.on("seek", this.props.onSeek), this.player.on("playerComplete", this.props.onEnded));
