...
const getSocialPolicies = (chainId: constants.StarknetChainId, options: SocialOptions = { pin: true, follow: true, member: true, guild: true, alliance: true }) => {
...
export default getSocialPolicies;