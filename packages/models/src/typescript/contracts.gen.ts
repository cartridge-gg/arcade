...
export function setupWorld(provider: DojoProvider) {
	...
	const build_Registry_associateCollection_calldata = (collectionAddress: string, editionId: BigNumberish): DojoCall => {
		return {
	...
	const Registry_associateCollection = async (snAccount: Account | AccountInterface, collectionAddress: string, editionId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const build_Registry_dissociateCollection_calldata = (collectionAddress: string, editionId: BigNumberish): DojoCall => {
		return {
			contractName: "Registry",
	...
	const Registry_dissociateCollection = async (snAccount: Account | AccountInterface, collectionAddress: string, editionId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const Registry_prioritizeEdition = async (snAccount: Account | AccountInterface, editionId: BigNumberish, priority: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const build_Registry_registerEdition_calldata = (worldAddress: string, namespace: BigNumberish, gameId: BigNumberish, project: string, rpc: string, policies: string, color: string, image: string, imageData: string, externalUrl: string, description: string, name: string, attributes: string, animationUrl: string, youtubeUrl: string, properties: string, socials: string): DojoCall => {
		return {
			contractName: "Registry",
	...
	const Registry_registerEdition = async (snAccount: Account | AccountInterface, worldAddress: string, namespace: BigNumberish, gameId: BigNumberish, project: string, rpc: string, policies: string, color: string, image: string, imageData: string, externalUrl: string, description: string, name: string, attributes: string, animationUrl: string, youtubeUrl: string, properties: string, socials: string) => {
		try {
			return await provider.execute(
				snAccount,
				build_Registry_registerEdition_calldata(worldAddress, namespace, gameId, project, rpc, policies, color, image, imageData, externalUrl, description, name, attributes, animationUrl, youtubeUrl, properties, socials),
				"ARCADE",
			);
		} catch (error) {
			console.error(error);
	...
	const build_Registry_registerGame_calldata = (worldAddress: string, namespace: BigNumberish, project: string, rpc: string, policies: string, color: string, gameImage: string, editionImage: string, externalUrl: string, description: string, gameName: string, editionName: string, gameAttributes: string, editionAttributes: string, animationUrl: string, youtubeUrl: string, properties: string, gameSocials: string, editionSocials: string): DojoCall => {
		return {
			contractName: "Registry",
			entrypoint: "register_game",
			calldata: [worldAddress, namespace, project, rpc, policies, color, gameImage, editionImage, externalUrl, description, gameName, editionName, gameAttributes, editionAttributes, animationUrl, youtubeUrl, properties, gameSocials, editionSocials],
		};
	};

	const Registry_registerGame = async (snAccount: Account | AccountInterface, worldAddress: string, namespace: BigNumberish, project: string, rpc: string, policies: string, color: string, gameImage: string, editionImage: string, externalUrl: string, description: string, gameName: string, editionName: string, gameAttributes: string, editionAttributes: string, animationUrl: string, youtubeUrl: string, properties: string, gameSocials: string, editionSocials: string) => {
		try {
			return await provider.execute(
				snAccount,
				build_Registry_registerGame_calldata(worldAddress, namespace, project, rpc, policies, color, gameImage, editionImage, externalUrl, description, gameName, editionName, gameAttributes, editionAttributes, animationUrl, youtubeUrl, properties, gameSocials, editionSocials),
				"ARCADE",
			);
		} catch (error) {
			console.error(error);
	...
	const build_Registry_updateEdition_calldata = (editionId: BigNumberish, project: string, rpc: string, policies: string, color: string, image: string, imageData: string, externalUrl: string, description: string, name: string, attributes: string, animationUrl: string, youtubeUrl: string, properties: string, socials: string): DojoCall => {
		return {
			contractName: "Registry",
	...
	const Registry_updateEdition = async (snAccount: Account | AccountInterface, editionId: BigNumberish, project: string, rpc: string, policies: string, color: string, image: string, imageData: string, externalUrl: string, description: string, name: string, attributes: string, animationUrl: string, youtubeUrl: string, properties: string, socials: string) => {
		try {
			return await provider.execute(
				snAccount,
				build_Registry_updateEdition_calldata(editionId, project, rpc, policies, color, image, imageData, externalUrl, description, name, attributes, animationUrl, youtubeUrl, properties, socials),
				"ARCADE",
			);
		} catch (error) {
			console.error(error);
	...
	const build_Registry_updateGame_calldata = (gameId: BigNumberish, color: string, image: string, imageData: string, externalUrl: string, description: string, name: string, attributes: string, animationUrl: string, youtubeUrl: string, properties: string, socials: string): DojoCall => {
		return {
			contractName: "Registry",
	...
	const Registry_updateGame = async (snAccount: Account | AccountInterface, gameId: BigNumberish, color: string, image: string, imageData: string, externalUrl: string, description: string, name: string, attributes: string, animationUrl: string, youtubeUrl: string, properties: string, socials: string) => {
		try {
			return await provider.execute(
				snAccount,
				build_Registry_updateGame_calldata(gameId, color, image, imageData, externalUrl, description, name, attributes, animationUrl, youtubeUrl, properties, socials),
				"ARCADE",
			);
		} catch (error) {
			console.error(error);
